...
<div class="mytrip-page">
  <h3>Enter your email ID to check out your travel bookings and Status</h3>
  <div class="email-space-mytrip">
  <label>Enter your EmailID:<input type="email" name="email" size="50"></label>
  <a href="bookedlist.php"><input class="btn btn-primary" type="submit" value="Submit"></a>
